...
<section>
    <header class="mb-6">
        <h2 class="text-lg font-semibold text-white">Зміна пароля</h2>
        <p class="mt-1 text-sm text-gray-500">Використовуйте довгий, надійний пароль для захисту акаунту.</p>
    </header>
    ...
    <form wire:submit="updatePassword" class="space-y-5">
        ...
        <div class="flex items-center gap-4">
            ...
            <x-action-message on="password-updated">Збережено.</x-action-message>
        </div>
    </form>
</section>
